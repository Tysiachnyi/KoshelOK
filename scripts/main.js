...
function windowLoadInit() {
	...
	$('#city-more').on('click', function () {
        $('.city-hide').slideDown(200);
		$(this).hide();
		$('#city-less').show();
    });
    $('#service-more').on('click', function () {
        $('.service-hide').slideDown(200);
        $(this).hide();
		$('#service-less').show();
    });
	$('#city-less').on('click', function () {
        $('.city-hide').slideUp(200);
        $(this).hide();
		$('#city-more').show();
    });
    $('#service-less').on('click', function () {
        $('.service-hide').slideUp(200);
        $(this).hide();
		$('#service-more').show();
    });
